...
# Render Web Service အတွက် Dummy Web Server ပြုလုပ်ခြင်း
...
def run_web_server():
    # Render က ပေးပို့တဲ့ PORT env ကို ရယူခြင်း (မရှိပါက default 8080)
...
if __name__ == '__main__':
    # Flask Web Server ကို စတင်ပွင့်စေခြင်း
    keep_alive()
    ...
    print("Bot is running perfectly with HTML mode...")
    app.run_polling()
